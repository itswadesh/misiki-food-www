<template>
  <div>
    ...
    <CleanModal :show="show" title="Allow Cookies" type="info" noicon>
      ...
      <div class="p-5 sm:p-10 max-w-2xl bg-blue-900 text-white">
        ...
        <div class="flex items-start justify-between space-x-5 sm:space-x-10">
          ...
          <ToggleSwitchWhite color="blue" class="hidden sm:block" />

          <ToggleSwitchWhite color="blue" size="sm" class="sm:hidden" />
        </div>
